...
im_d = double(imread(im_file));     % matlab imread -> unit8
% imshow(uint8(im_d));
...
%% ================== plane growing  =======================
load('Scene4_SeedName_SQUARE_SeedSize_016.mat');
...
if i==1
%%%%%%%%%%%%%%%%%%% Scene 1 %%%%%%%%%%%%%%%%%%%%%%%%%
im_GT_name='DPD_test_images/SR4000_test_images/Scene1_GT.bmp';
Plane_index_gt=[129 225 213 86 226 88 116 35];
elseif i==2
%%%%%%%%%%%%%%%%%%% Scene 2 %%%%%%%%%%%%%%%%%%%%%%%%%
 im_GT_name='DPD_test_images/SR4000_test_images/Scene2_GT_new.bmp';
 Plane_index_gt=[239 55 232 213 62];
elseif i==3
%%%%%%%%%%%%%%%%%%% Scene 3 %%%%%%%%%%%%%%%%%%%%%%%%%
 im_GT_name='DPD_test_images/SR4000_test_images/Scene3_GT.bmp';
 Plane_index_gt=[83 155 123 218 180 18 225];
elseif i==4
 %%%%%%%%%%%%%%%%%%% Scene 4 %%%%%%%%%%%%%%%%%%%%%%%%%
 im_GT_name='DPD_test_images/SR4000_test_images/Scene4_GT.bmp';
 Plane_index_gt=[123 155 137 200 201 217];
elseif i==5
 %%%%%%%%%%%%%%%%%%% Scene 5 %%%%%%%%%%%%%%%%%%%%%%%%%
 im_GT_name='DPD_test_images/SR4000_test_images/Scene5_GT_new1.bmp';
